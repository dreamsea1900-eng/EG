...
1. **VIP獎勵標題 icon**：原用 `🎮` emoji，已換為 Figma 的 `icon_main_providers` 圖片
   （`https://www.figma.com/api/mcp/asset/1c46bbd4-78b5-46bc-ae63-8c2e6add38cf`，30×30px）。
   對應 title 節點 `9955:28716`，7 天後失效需下載。
